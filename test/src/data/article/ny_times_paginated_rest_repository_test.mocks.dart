...
// in allthenews/test/src/data/article/ny_times_paginated_rest_repository_test.dart.
...
import 'package:allthenews/src/domain/model/article.dart' as _i9;
import 'package:allthenews/src/domain/nytimes/ny_times_repository.dart' as _i8;
...
/// A class which mocks [NYTimesRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockNYTimesRepository extends _i1.Mock implements _i8.NYTimesRepository {
  MockNYTimesRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i9.Article>> getMostPopularArticles() =>
      (super.noSuchMethod(Invocation.method(#getMostPopularArticles, []),
              returnValue: Future<List<_i9.Article>>.value(<_i9.Article>[]))
          as _i3.Future<List<_i9.Article>>);
  @override
  _i3.Future<List<_i9.Article>> getNewestArticles() =>
      (super.noSuchMethod(Invocation.method(#getNewestArticles, []),
              returnValue: Future<List<_i9.Article>>.value(<_i9.Article>[]))
          as _i3.Future<List<_i9.Article>>);
}
